  ...
  return (
    <div>
      <Navbar color="primary" dark expand="md">
        <NavbarBrand tag={Link} to="/">rarita</NavbarBrand>
        ...
        <Collapse isOpen={isOpen} navbar>
          ...
          <Nav Classname="ml-auto" navber>
          <NavLink tag={Link} to="/profile">เข้าสู่ระบบ</NavLink>
          <NavLink tag={Link} to="/profile">ขสมัครสมาชิก</NavLink>
          </Nav>
        </Collapse>
      </Navbar>
    </div>
